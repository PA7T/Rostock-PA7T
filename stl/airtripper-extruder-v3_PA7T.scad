...
module bsp_push_fit() {
	...
	difference() {
		...
		translate([-1,7,15]) rotate([0,90,0]) cylinder(19, r=2, $fn=30);
...
module infeed_block() {
	...
	if (infeed_choice == 2) {
		difference() {
			...
			translate([8,4,12]) rotate([0,-90,0]) cylinder(22, r=2, $fn=25);
			translate([-2.9,4,12]) rotate([0,-90,0]) cylinder(12, r=3.15, $fn=60);
			translate([0,4,12]) rotate([0,-90,0]) cylinder(3, r1=2.0, r2=3.15, $fn=60);
		}
	}
